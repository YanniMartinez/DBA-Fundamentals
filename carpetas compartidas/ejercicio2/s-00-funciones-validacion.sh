...
# Param 1: Número de renglón
# Param 2: Status - resultado de la validación
# Param 3: Valor esperado
# Param 4: Valor obtenido
# Param 5: Mensaje positivo
# Param 6: Mensaje de error
fv_assert(){
  row=${1}
  condicion="${2}"
  esperado="${3}"
